...
export declare class AI {
    ...
    constructor(apiBase: string, auth: AuthLike);
    ...
    chat(messages: ChatMessage[], opts?: GenerateOptions): Promise<GenerateResult>;
    /** Embed one or many strings. Pass a string for a single embedding, or string[] for a batch. */
    embed(text: string | string[], opts?: EmbedOptions): Promise<EmbedResult>;
    private post;
}
export {};
